...
class nature_object_env(object_localization_env):
	def __init__(self):
		super(nature_object_env,self).__init__()
	...
	def read_one_image(self):
		image,all_bbox,all_bbox_name = self.data_obj.get_natural_image_with_boundingBox()
		self.all_bbox	=	all_bbox
		self.Annotations_name = all_bbox_name
